		...
		<div className="dashboard">
			<div className="dashboard-card">
				...
				>
					...
					>
						<ReceiptIcon className="dashboard-option-icon" />{" "}
						{t("addtransaction")}{" "}
					</p>
					<p
						className={`dashboard-option ${
					...
					>
						<AccountBoxIcon className="dashboard-option-icon" />{" "}
						{t("getmember")}{" "}
					</p>
					<p
						className={`dashboard-option ${
					...
					>
						<PersonAddIcon className="dashboard-option-icon" /> {t("addmember")}{" "}
					</p>
					<p
						className={`dashboard-option ${
					...
					>
						<AssignmentReturnIcon className="dashboard-option-icon" />{" "}
						{t("returntransaction")}{" "}
					</p>

			...
			<div className="dashboard-card">
				...
				>
					<div className="dashboard-logo">
						...
						<p className="logo-name">{t("logo")}</p>
					</div>
					<a
						href="#profile@member"
					...
					>
						<LocalLibraryIcon className="dashboard-option-icon" /> {t("active")}
					</a>
					<a
					...
					>
						<HistoryIcon className="dashboard-option-icon" /> {t("history")}
					</a>
					<a
						href="#profile@member"
						className={`dashboard-option ${
					...
					>
						<PowerSettingsNewIcon className="dashboard-option-icon" />{" "}
						{t("logout")}{" "}
					</a>
				</div>
				...
				<div className="dashboard-option-content">
					...
					<div className="member-activebooks-content" id="activebooks@member">
						<p className="member-dashboard-heading">{t("issued")}</p>
					...
					>
						<p className="member-dashboard-heading">{t("reserved")}</p>
						<table className="activebooks-table">
							<tr>
								<th>{t("sno")}</th>
								<th>{t("book_name")}</th>
					...
					<div className="member-history-content" id="history@member">
						<p className="member-dashboard-heading">{t("history")}</p>
						<table className="activebooks-table">
							<tr>
								<th>{t("sno")}</th>
								<th>{t("book_name")}</th>
